...
import {
  notSpecified,
  type EffectInfo as EffectInfoType
} from '../../../data/commonParams';
      ...
      <div className={styles.card} aria-busy>
        <div className={styles.badgeRow}>
          <Skeleton
            ...
            height="24px"
            rounded
            aria-label="Mode loading"
          />
          <Skeleton
            width="90px"
            height="18px"
            rounded
            aria-label="Selector loading"
          />
        </div>
    ...
    return (
      <div className={styles.empty}>
        ...
        <p className={styles.emptyCopy}>
          Pick a detent or use search to see the full description, knob
          behaviors, and notes.
        </p>
      </div>
    );
    ...
    <div className={styles.card}>
      <div className={styles.badgeRow}>
        ...
        <span className={styles.selectorIndex}>
          Selector #{effect.selectorIndex + 1}
        </span>
      </div>
